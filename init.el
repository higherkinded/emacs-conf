...
(custom-set-variables
 ...
 '(package-selected-packages
   '(rjsx-mode react-mode typescript-tsx web-mode typescript-mode treemacs-evil slime treemacs rainbow-delimiters company lsp-ui company-mode lsp-mode evil-leader)))
(custom-set-faces
